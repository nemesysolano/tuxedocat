...
namespace trading::engine::executionhandler {
    ...
    expected<unique_ptr<SimulationExecutionHandler>, TuxedoError> SimulationExecutionHandler::Create(reference_wrapper<DataHandler> datahandler, reference_wrapper<Queue<unique_ptr<Event>>>  events) {        
