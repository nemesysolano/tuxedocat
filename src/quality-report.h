...
namespace reports {
    class QualityReport {
        ...
        public:
            QualityReport(const string & file_path, BinaryConfusionMatrix logistic, BinaryConfusionMatrix linear_discriminant): file_path_(file_path), logistic_(logistic), linear_discriminant_(linear_discriminant) {}
