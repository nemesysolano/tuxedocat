...
namespace timeseries::momenta {
    ...
    class Features {
        private:
            ...
            Features(const DataFrame & data_frame, const std::vector<std::string> & momentum_column_names)
        ...
        public:
            ...
            static Features CreateMomenta(const DataFrame & df);
            static Features CreateZScores(const DataFrame & df);
